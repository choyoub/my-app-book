...
- 연결에 성공하면 위젯이 자동으로 나타나고, 연결 해제나 통신 오류가 발생하면 자동으로 숨겨집니다.
...
Tailscale이 연결된 신뢰 가능한 기기에서만 리모콘을 켜 두는 것을 권장합니다. 현재 MVP 프로토콜은 Tailscale의 암호화와 접근 제어를 전제로 하며 별도 앱 암호를 사용하지 않습니다. Android 앱 프로세스가 종료되면 리모콘 서버도 함께 종료됩니다.
